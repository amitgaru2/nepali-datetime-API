...
# def nepali_datetime_date_convert_bs_ad(bs_date: str = Query('%Y-%m-%d', alias='format')):
#     return {}


# @app.get("/date/convert/ad-bs", response_model=DateResponse)
# def nepali_datetime_date_convert_ad_bs(ad_date: str = Query('%Y-%m-%d', alias='format')):
#     return {}
